...
if exports and exports["lmodeextended"] then
	-- Get the base ESX shared object and the ExM shared object acts as overrides for the ExM object we are about to create
	local ESX = exports["lmodeextended"]:getSharedObject()
	local ExM_overrides = exports["lmodeextended"]:getlmodeextendedObject()
