...
Strings = {
    ['press_start'] = 'Appuyez sur ~INPUT_CONTEXT~ pour ~g~obtenir une boule de bowling',
    ['force'] = 'Puissance : %s',
    ['strike'] = {"Bowling", "VOUS AVEZ FAIT UN STRIKE"},
    ['spare'] = {'Bowling', 'Bien joué ! Vous avez fait un spare'},
    ['x_pinsdown'] = {'Bowling', 'Vous avez %s sur %s quilles'},
    ['this_occupied'] = 'Cette piste de bowling est occupée.',
    ['every_occupied'] = 'Chaque piste de bowling est occupée.',
    ['blip'] = 'Bowling'
}